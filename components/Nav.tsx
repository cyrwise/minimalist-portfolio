...
export default function Nav() {
  ...
  return (
    <motion.nav 
      ...
      className="sticky top-0 z-50 flex flex-col py-6 md:py-8 border-b-2 border-border mb-12 backdrop-blur-md bg-bg/80 w-full transition-colors duration-300"
    >
      <div className="flex justify-between items-center w-full">
        <Link href="/">
          <h1 className="text-2xl font-black tracking-tighter hover:text-accent transition-colors cursor-pointer uppercase text-fg">
        ...
        <div className="hidden md:flex gap-6 items-center text-sm font-bold tracking-widest uppercase text-fg">
          ...
          {mounted && (
            <button
              ...
              className="cursor-pointer p-2 border-2 border-border rounded-full hover:border-accent hover:text-accent transition-all flex items-center justify-center w-10 h-10"
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col gap-4 text-sm font-bold tracking-widest uppercase text-fg items-center mt-6 pb-2">
              <Link href="/#experience" onClick={toggleMenu} className="hover:text-accent transition-colors py-2 w-full text-center">
                Experience
              </Link>
              <Link href="/#projects" onClick={toggleMenu} className="hover:text-accent transition-colors py-2 w-full text-center">
                Projects
              </Link>
